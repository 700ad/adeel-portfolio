...
class WEBGL {
  ...
  update() {
    this.plane.onRender(() => {
      ...
      this.plane.uniforms.resolution.value = [500, 500];
    });
  }

  initEvent() {
    this.planeElement.addEventListener("mousemove", (e) => {
      gsap.to(this.plane.uniforms.mousepos.value, 0.4, {
        0: e.clientX,
        1: 1000 - e.clientY,
      });
    });
...
export default function TempAbout() {
  useEffect(() => {
    ...
    let webGLCurtain = new Curtains({ container: "canvas" });
    ...
    const update = () => {
      plane.onRender(() => {
        ...
        plane.uniforms.resolution.value = [500, 500];
      });
    };

    const initEvent = () => {
      planeElement.addEventListener("mousemove", (e) => {
        gsap.to(plane.uniforms.mousepos.value, 0.4, {
          0: e.clientX,
          1: 1000 - e.clientY,
        });
      });
      ...
      <div className=" fixed inset-0">
        <div className="container-page">
          ...
          <div className="top-items">
            <div
              className="top__item__description item__description"
              data-number="01"
            >
          ...
          <div className="bottom-items">
            <div
              className="bottom_item__description item__description"
              data-number="04"
            >
              Words are cheap
            </div>
            <div
              ...
              data-number="05"
            >
              The biggest you can say is Elephant
            </div>
            <div
              className="bottom_item__description item__description"
              data-number="06"
            >
              Dispair is a powerful narcotic
            </div>
          </div>
        </div>
      </div>
